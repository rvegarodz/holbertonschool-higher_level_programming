...
class TestRectangle(unittest.TestCase):
    ...
    def test_display_error(self):
        self.assert_stdout("ValueError: width must be > 0", 0, 1, 0, 0)
        self.assert_stdout("TypeError: width must be an integer", None, 0, 0, 0)
        self.assert_stdout("ValueError: height must be > 0", 1, 0, 0, 0)
        self.assert_stdout("TypeError: height must be an integer", 1, None, 0, 0)
